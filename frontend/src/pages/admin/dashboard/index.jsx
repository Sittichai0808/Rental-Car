import { getAdminDashboard, getTotalRevenueByMonth } from "@/apis/admin-dashboard.api";
import { GET_ADMIN_DASHBOARD, GET_TOTAL_REVENUE_BY_MONTH } from "@/constants/react-query-key.constant";
...
ChartJS.register(CategoryScale, LinearScale, PointElement, BarElement, LineElement, Title, Tooltip, Filler, Legend);
    ...
    <div>
      <div className="mt-10 grid grid-cols-4 gap-4">
        <div className="shadow-lg rounded-md p-6 flex flex-col justify-center items-center">
          <div className="text-3xl font-bold mb-1">{data?.totalBookingByMonth}</div>
        ...
        <div className="shadow-lg rounded-md p-6 flex flex-col justify-center items-center">
          <div className="text-3xl font-bold mb-1">{formatCurrency(data?.totalRevenue)}</div>
          <span>doanh thu</span>
        </div>
      </div>
