...
import { Typography, Button, Avatar, Input, Modal, Select, Form } from "antd";
import { EditOutlined, UserOutlined, LinkOutlined, FolderAddOutlined } from "@ant-design/icons";
...
export default function AccountPage() {
  ...
  return (
    <div className="flex flex-col gap-5">
      <div className="flex flex-col pl-10 pr-5 py-5  rounded-xl bg-gray-300">
              ...
              <div className="relative bg-transparent rounded-lg">
                ...
                <div className="flex flex-col">
                  <div className="flex flex-col w-full justify-between">
                    <Title level={5} className="flex items-center text-sm font-medium">
                      Tên tài khoản
                    </Title>
                    <StyleInput type="text" placeholder="Email" size="small" defaultValue="Thịnh Tsubasa" />
                  </div>
                  <div className="flex flex-col w-full justify-between">
                    <Title level={5} className="flex items-center text-sm font-medium">
                      Ngày sinh
                    </Title>
                    <StyleInput type="text" placeholder="Email" size="small" defaultValue="01-01-1950" />
                  </div>
                  <div className="flex flex-col w-full justify-between">
                    <Title level={5} className="flex items-center text-sm font-medium">
                      Số điện thoại
                    </Title>
                    <StyleInput type="text" placeholder="Email" size="small" defaultValue="0149049104" />
                  </div>
                  <div className="flex flex-col w-full justify-between">
                    <Title level={5} className="flex items-center text-sm font-medium">
                      Email
                    </Title>
                    <StyleInput type="text" placeholder="Email" size="small" defaultValue="messithinh12345@gmail.com" />
                  </div>
                  <div className="flex flex-col w-full justify-between">
                    <Title level={5} className="flex items-center text-sm font-medium">
                      Giới tính
        ...
        <div className="flex content ">
          <div className="flex flex-col items-center font-bold w-1/3 pt-5">
            <Avatar className="flex justify-center " size={100} icon={<UserOutlined />} />
          ...
          <div className="flex flex-col w-2/3 ">
            <div className="flex flex-col rounded-lg  bg-gray-100 pl-5   ">
            ...
            <div className="flex flex-col  ">
              <div className="w-full flex items-center justify-between  ">
                <Title level={5} className=" flex items-center text-xs font-medium ">
                  Số điện thoại
                </Title>
      ...
      <div className="flex flex-col  pl-10 pr-5   rounded-xl bg-gray-300">
        <div className="flex title items-center justify-between">
        ...
        <div className="content flex flex-row ">
          ...
          <div className=" w-full flex flex-col  ">
            ...
            <Image
              ...
              src="https://n1-ppstg.mioto.vn/g/2023/07/28/09/84-H_XxlK_HfclkzKuIFpg.jpg"
              alt="bgImage"
              width={100}
              height={100}
              loader={loaderProp}
      ...
      <div className="flex flex-col pl-10 pr-5 rounded-xl bg-gray-300 ">
        <div className="w-full flex flex-col title items-baseline justify-between">
          <div className="flex flex-col">
      ...
      <div className="flex flex-col pl-10 pr-5 rounded-xl bg-gray-300 ">
        ...
        <div className="flex flex-col justify-center items-center ">
          <Image
            ...
            unoptimized={true}
          />
          <Title className="font-semibold text-xl text-zinc-400">Bạn chưa có thẻ nào</Title>
        </div>
      </div>
      <div className="flex flex-col pl-10 pr-5 rounded-xl bg-gray-300 ">
        <div className="flex items-center justify-between">
        ...
        <div className="flex flex-col justify-center items-center ">
          <Image
            ...
            unoptimized={true}
          />
          <Title className="font-semibold text-xl text-zinc-400">Không tìm thấy xe nào</Title>
        </div>
      </div>
    </div>
  );
